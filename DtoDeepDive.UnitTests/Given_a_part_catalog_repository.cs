...
namespace DtoDeepDive.UnitTests {
    public class Given_a_part_catalog_repository {
        private readonly ITestOutputHelper _output;
        private readonly IPartsCatalogDbContext _db;
        public Given_a_part_catalog_repository(ITestOutputHelper output) {
            _output = output;
        ...
        [Fact]
        public void when_getting_all_parts_from_catalog() {
