...
//     Connection String:      "Data Source=NICKCDESKTOP\SQLEXPRESS;Initial Catalog=PartsCatalog;Integrated Security=True;Connect Timeout=15;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"
// ------------------------------------------------------------------------------------------------
...
namespace DtoDeepDive.Data
{
    ...
    public class Part
    {
        ...
        public string UnitOfMeasure { get; set; } // UnitOfMeasure
        public string SmartPart { get; set; } // SmartPart
        ...
        public bool InvalidError { get; set; } // InvalidError
        public bool PreCosted { get; set; } // PreCosted
        public bool IsiQuoteGenerated { get; set; } // IsiQuoteGenerated
        public string ParentNum { get; set; } // ParentNum
        public string Environment { get; set; } // Environment
        public string TransferFrom { get; set; } // TransferFrom
    ...
    public class PartConfiguration : EntityTypeConfiguration<Part>
    {
        ...
        public PartConfiguration(string schema)
        {
            ...
            Property(x => x.UnitOfMeasure).HasColumnName("UnitOfMeasure").IsOptional().HasColumnType("nvarchar");
            Property(x => x.SmartPart).HasColumnName("SmartPart").IsOptional().HasColumnType("nvarchar");
            Property(x => x.HiddenSpec).HasColumnName("HiddenSpec").IsOptional().HasColumnType("nvarchar");
            Property(x => x.ErrorData).HasColumnName("ErrorData").IsOptional().HasColumnType("nvarchar");
            ...
            Property(x => x.InvalidError).HasColumnName("InvalidError").IsRequired().HasColumnType("bit");
            Property(x => x.PreCosted).HasColumnName("PreCosted").IsRequired().HasColumnType("bit");
            Property(x => x.IsiQuoteGenerated).HasColumnName("IsiQuoteGenerated").IsRequired().HasColumnType("bit");
            Property(x => x.ParentNum).HasColumnName("ParentNum").IsOptional().HasColumnType("nvarchar");
            Property(x => x.Environment).HasColumnName("Environment").IsOptional().HasColumnType("nvarchar");
            Property(x => x.TransferFrom).HasColumnName("TransferFrom").IsOptional().HasColumnType("nvarchar");
